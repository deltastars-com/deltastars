        ...
        <div className="space-y-6 text-black">
          ...
          <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
            ...
            <div className="space-y-2 text-sm font-bold">
                ...
                <p><span className="text-gray-400">Password:</span> <span className="font-mono bg-white px-3 py-1 rounded-lg border">733691903***</span></p>
            </div>
          </div>
          ...
          <div className="bg-orange-50 p-6 rounded-3xl border border-orange-100">
            ...
            <p><strong>PIN:</strong> <span className="font-mono bg-white px-4 py-1 rounded-lg border border-orange-200 text-orange-800">733691903***</span></p>
          </div>
        </div>
